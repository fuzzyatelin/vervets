...
- **The Trudy Turner Vervet Monkey Sample Archive** is held at the
  Sensory Morphology and Anthropological Genomics Lab (SMAGL) at Boston
  ...
  Milwaukee) in the course of over 60 years of working with wild savanna
  monkeys (*Chlorocebus* spp.), including a large portion generated
  while leading field collections with the IVRC. The archive is
  comprised of thousands of wild vervet samples from across Africa and
  the Caribbean, predominantly clipped fur samples and dried blood
  spots. These samples were generated by funding from the NIH
  (R01RR01163009), NSF (SOC-74-24166, BNS-770-3322, BCS-0938969), the
  University of Wisconsin – Milwaukee, the University of the Free State
  (South Africa), the University of Limpopo (South Africa), and the
  Coriell Institute.
...
- **The Vervet Monkey Plasma Clot Archive** is held by the [University
  ...
  with the production of STR/microsatellite markers from wild vervet
  monkeys (*Chlorocebus pygerythrus pygerythrus*) collected in
  Soetdoring Nature Reserve, a private farm in Gariep Dam, and Sandveld
  Nature Reserve, South Africa. These markers were generated from plasma
  clots from wild collections associated with the BU/NWU Vervet Monkey
  Sample Archive, and generated by funding from Boston University. In
  agreement with UPVGL standards the source clots are now part of their
  public sample archive and under their curation.
